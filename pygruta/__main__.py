...
def usage():
    ...
    print("gemini-snapshot {src} {outdir} [url_prfx]  Creates a Gemini snapshot")
    ...
    if len(args) < 2:
        ...
        if cmd == "topics":
            ...
            if story is None:
                ...
                if editor:
                    tmpfile = "/tmp/pygruta-post-%f.%s" % (time.time(), ext)
            ...
            if len(args) < 1:
                ...
                pygruta.gemini.snapshot(gruta, outdir, url_prefix)
